...
export class PostgresUserService implements IServicelocator {
  ...
  async findAllUserDetails(userSearchDto) {
    ...
    const query = `SELECT U."name",U."userId",U."enrollmentId", U."username",U."email", U."firstName",UTM."tenantId", U."middleName", U."lastName", U."gender", U."dob", R."name" AS role, U."mobile", U."createdBy",U."updatedBy", U."createdAt", U."updatedAt", U."status", COUNT(*) OVER() AS total_count 
      FROM  public."Users" U
