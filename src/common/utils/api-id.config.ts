export const APIID = {
  ...
  SEND_OTP_MAIL: 'api.send.otp.mail',
  REQUEST_MAGIC_LINK: 'api.magic.link.request',
  VALIDATE_MAGIC_LINK: 'api.magic.link.validate',
  COHORT_CONTENT_CREATE: 'api.cohort.content.create',
