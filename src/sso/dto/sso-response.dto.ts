...
export class SsoResponseDto {
  ...
  @ApiProperty({ type: Boolean, description: 'Whether user is new or existing' })
  @Expose()
  isNewUser: boolean;
  ...
  @ApiPropertyOptional({ type: String, description: 'Access token for new users' })
  @Expose()
  accessToken?: string;

  @ApiPropertyOptional({ type: String, description: 'Refresh token for new users' })
  @Expose()
  refreshToken?: string;
