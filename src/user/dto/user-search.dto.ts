...
export class setFilters {
  ...
  @ApiPropertyOptional({
    type: [String],
    description:
      "tenantStatus - Status from UserTenantMapping table (active, inactive, archived)",
  })
  @IsOptional()
  @IsArray()
...
export class UserSearchDto {
  ...
  @ApiPropertyOptional({
    type: String,
    description:
      "Include custom fields in response (default: true). Set to false for faster response.",
    default: "true",
  })
  @Expose()
  @IsOptional()
